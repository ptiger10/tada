...
// 	data := "foo, bar\n baz, qux\n corge, fred"
// 	df, _ := tada.NewReader(strings.NewReader(data)).Read(tada.WithHeaders(0))
// 	fmt.Println(df)
// 	// Output:
// 	// +---++-------+------+
// 	// | - ||   0   |  1   |
...
// 	data := "foo, bar\n baz, qux\n corge, fred"
// 	df, _ := tada.NewReader(strings.NewReader(data)).Read(tada.WithHeaders(2))
// 	fmt.Println(df)
// 	// Output:
// 	// +---++-------+------+
// 	// |   ||  foo  | bar  |
...
// 	data := ", foo, bar\n labels, baz, qux\n 1, corge, fred"
// 	df, _ := tada.NewReader(strings.NewReader(data)).Read(tada.WithHeaders(2), tada.WithLabels(1))
// 	fmt.Println(df)
// 	// Output:
// 	// +--------++-------+------+
// 	// |        ||  foo  | bar  |
...
// 	baz, qux
// 	corge, fred`
// 	df, _ := tada.NewReader(strings.NewReader(data)).Read(tada.WithLabels(1))
// 	fmt.Println(df)
// 	// Output:
// 	// +-------++------+
// 	// |  foo  || bar  |
...
// 	baz|qux
// 	corge|fred`
// 	df, _ := tada.NewReader(strings.NewReader(data)).Read(tada.WithDelimiter('|'))
// 	fmt.Println(df)
// 	// Output:
// 	// +---++-------+------+
// 	// | - ||  foo  | bar  |
...
// 		{"corge", "fred"},
// 	}
// 	df, _ := tada.NewCSVReader(data).Read()
// 	fmt.Println(df)
// 	// Output:
// 	// +---++-------+------+
// 	// | - ||  foo  | bar  |
...
// 		{"corge", "fred"},
// 	}
// 	df, _ := tada.NewCSVReader(data).Read(tada.ByColumn())
// 	fmt.Println(df)
// 	// Output:
// 	// +---++-----+-----+-------+
// 	// | - || foo | baz | corge |
