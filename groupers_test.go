...
func TestGroupedSeries_stringFunc(t *testing.T) {
	...
	tests := []struct {
			...
			fields: fields{
				...
				series: &Series{
					values: &valueContainer{
						slice: []string{"a", "b", "c", "d"}, isNull: []bool{false, false, false, false}},
					labels: []*valueContainer{
						{slice: []string{"foo", "foo", "bar", "bar"}, isNull: []bool{false, false, false, false}, name: "*0"}}}},
		...
		},
		{
			...
			want: &Series{values: &valueContainer{slice: []string{"a", "a", "c", "c"}, isNull: []bool{false, false, false, false}, name: "first"},
